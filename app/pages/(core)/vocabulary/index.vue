...
<template>
  <div class="space-y-6 h-[calc(100vh-8rem)] flex flex-col">
    ...
    <div class="flex items-center justify-between">
      ...
      <div
        class="text-sm font-medium text-gray-500 bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-full"
      >
    ...
    <!-- Main Card Area -->
    <div
      class="flex-1 flex flex-col justify-center max-w-xl mx-auto w-full perspective"
    >
      <div
      ...
      >
        ...
        <div
          class="absolute inset-0 backface-hidden glass-card rounded-[2.5rem] p-8 md:p-12 flex flex-col justify-between border-b-8 border-gray-200 dark:border-gray-800 shadow-xl"
        >
          <div class="flex items-center justify-between">
            <span
            ...
            <button
              ...
              class="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center hover:bg-primary-500 hover:text-white transition-colors z-10"
            >
              <NuxtIcon
                :name="
          ...
          <div class="text-center">
            ...
            <div
              class="w-8 h-1 bg-gray-200 dark:bg-gray-700/50 rounded-full mx-auto"
            />
          </div>
        </div>
        ...
        <div
          class="absolute inset-0 backface-hidden rotate-y-180 glass-card rounded-[2.5rem] p-8 md:p-12 flex flex-col justify-between bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-xl overflow-y-auto"
        >
          <div>
            <h3
            ...
            <div
              class="p-6 rounded-2xl bg-primary-50 dark:bg-primary-900/10 border-l-4 border-primary-500"
            >
              <p
          ...
          <div
            class="pt-6 mt-6 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between"
          >
            <div class="flex flex-col">
              <span class="text-xs font-bold text-gray-400 uppercase mb-1"
                >Mastery</span
              >
    ...
    <div class="text-center pb-4 animate-slide-up">
      <NuxtLink
        to="/vocabulary/list"
        class="text-sm font-medium text-gray-500 hover:text-primary-600 transition-colors underline decoration-dotted underline-offset-4"
      >
